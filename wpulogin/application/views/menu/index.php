        ...
        <div class="row">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td><?= $m['menu']; ?></td>
		      <td>
		      	<a href="" data-id="<?= $m['id'];?>" data-menu="<?= $m['menu'];?>" class="badge badge-success" data-toggle="modal" data-target="#editMenuModal">edit</a>
...
<!-- ===================================================================================== -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
            <input type="text" class="form-control" id="menuedit" name="menu" placeholder="Edit Menu name">
            </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
   ...
   <script type="text/javascript">
      ...
      $("#editMenuModal").on('show.bs.modal',(event)=>{
        var btn = $(event.relatedTarget)
        var id = btn.data('id');
        var menu = btn.data('menu');
        $(".modal-body #id").val(id)
        $(".modal-body #menuedit").val(menu)
      })
